  ...
  group('SpeedCalculator', () {
    group('calculate', () {
      ...
      test('should not exceed initial speed', () {
        ...
        expect(
          speed,
          lessThanOrEqualTo(SnakeGameConfig.gameSpeedInitial.toDouble()),
        );
      });

      test('should use logarithmic scaling', () {
        final speed0 = SpeedCalculator.calculate(0);
        final speed50 = SpeedCalculator.calculate(50);
        final speed100 = SpeedCalculator.calculate(100);

        final diff1 = speed0 - speed50;
        final diff2 = speed50 - speed100;

        // Logarithmic scaling means that for the same increase in score,
        // the speed decrease is larger at lower scores.
