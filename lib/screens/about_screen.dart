          ...
          child: ListView(
            ...
            children: [
              ...
              _buildSectionContent(
                context,
                'about_screen_disclaimer_content'.tr(),
              ),
              _buildSectionTitle(
                context,
                'about_screen_contribution_title'.tr(),
              ),
              _buildSectionContent(
                context,
              ...
              _buildLink(
                context,
                'about_screen_github_link'.tr(),
                'https://github.com/ddcq/personal-oracle',
              ),
              _buildSectionTitle(context, 'about_screen_creators_title'.tr()),
              _buildSectionContent(
                context,
                'about_screen_creators_content'.tr(),
              ),
              const SizedBox(height: 8),
              _buildSectionContent(
                context,
                '${'about_screen_creators_lead_dev'.tr()} Denis Declercq',
              ),
              ...
              _buildSectionContent(
                context,
                'about_screen_roadmap_content'.tr(),
              ),
              _buildSectionTitle(context, 'about_screen_legal_title'.tr()),
              _buildLink(
                context,
                'about_screen_terms_link'.tr(),
                'https://ddcq.github.io/orable-asgard-privacy-policy.html',
              ),
              _buildLink(
                context,
                'about_screen_privacy_link'.tr(),
                'https://ddcq.github.io/orable-asgard-privacy-policy.html',
              ),
              ListTile(
                title: Text(
                  'about_screen_contact_us'.tr(),
