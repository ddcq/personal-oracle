...
class SnakeComponent extends PositionComponent
  ...
  SnakeComponent({
    ...
    _cornerCenters = {
      ...
      '1,0,0,-1': [_right, _top],
      // Bottom-Left
      '0,1,-1,0': [_bottom, _left],
      '-1,0,0,1': [_left, _bottom],
      // Bottom-Right
      '0,1,1,0': [_bottom, _right],
      '1,0,0,1': [_right, _bottom],
      // Horizontal
      '-1,0,1,0': [_left, _right],
      '1,0,-1,0': [_right, _left],
      // Vertical
      '0,-1,0,1': [_top, _bottom],
      '0,1,0,-1': [_bottom, _top],
    };
