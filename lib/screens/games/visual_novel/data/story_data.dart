  ...
  static Map<String, Scene> get _actIIScenes => {
    ...
    'scene_first_choice': Scene(
      ...
      choices: [
        Choice(
          ...
          consequence: EmotionalConsequence(
            prideChange: 8,
            bitternessChange: 3,
          ),
    ...
    'scene_malice_hair_cut': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_sif'.tr(),
          text: 'vn_scene_malice_hair_cut_d4'.tr(),
    ...
    'scene_malice_thor_fury': Scene(
      ...
      dialogues: [
        DialogueLine(
          speaker: 'vn_sif'.tr(),
          text: 'vn_scene_malice_thor_fury_d1'.tr(),
          characterImage: 'assets/images/vn/sif_shocked.webp',
        ),
        DialogueLine(
          speaker: 'vn_thor'.tr(),
          text: 'vn_scene_malice_thor_fury_d2'.tr(),
          characterImage: 'assets/images/vn/thor_angry.webp',
        ),
        DialogueLine(
          speaker: 'vn_thor'.tr(),
          text: 'vn_scene_malice_thor_fury_d3'.tr(),
          characterImage: 'assets/images/vn/thor_angry.webp',
        ),
        DialogueLine(
          speaker: 'vn_thor'.tr(),
    ...
    'scene_malice_promise_hair': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_thor'.tr(),
          text: 'vn_scene_malice_promise_hair_d2'.tr(),
          characterImage: 'assets/images/vn/thor_angry.webp',
        ),
        DialogueLine(
          speaker: 'vn_speaker_narrateur'.tr(),
          text: 'vn_scene_malice_promise_hair_d3'.tr(),
        ),
      ],
    ...
    'scene_drunk_mead_fest': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          ...
          characterImage: 'assets/images/vn/loki_drunk.webp',
        ),
        DialogueLine(
          speaker: 'vn_loki'.tr(),
    ...
    'scene_drunk_accident': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_sif'.tr(),
          text: 'vn_scene_drunk_accident_d4'.tr(),
          characterImage: 'assets/images/vn/sif_shocked.webp',
        ),
        DialogueLine(
          speaker: 'vn_loki'.tr(),
    ...
    'scene_drunk_thor_discovery': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_speaker_narrateur'.tr(),
          text: 'vn_scene_drunk_thor_discovery_d5'.tr(),
        ),
      ],
    ...
    'scene_dwarves_sons_ivaldi': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_speaker_narrateur'.tr(),
          text: 'vn_scene_dwarves_sons_ivaldi_d1'.tr(),
        ),
        DialogueLine(
        ...
        DialogueLine(
          speaker: 'vn_brokkr'.tr(),
          text: 'vn_dwarves_sons_ivaldi_d3_brokkr'.tr(),
          characterImage: 'assets/images/vn/brokkr_suspicious.webp',
        ),
      ],
    ...
    'scene_dwarves_sons_ivaldi_drunk': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_loki'.tr(),
          text: 'vn_scene_dwarves_sons_ivaldi_drunk_d2'.tr(),
          characterImage: 'assets/images/vn/loki_nervous.webp',
        ),
        DialogueLine(
          speaker: 'vn_brokkr'.tr(),
    ...
    'scene_bet_brokkr_eitri_drunk': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_brokkr'.tr(),
          text: 'vn_scene_bet_brokkr_eitri_drunk_d5_brokkr'.tr(),
          characterImage: 'assets/images/vn/brokkr_amused.webp',
        ),
      ],
    ...
    'scene_proactive_forges': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          speaker: 'vn_loki'.tr(),
          text: 'vn_ending_artisan_p1_loki_thought'.tr(),
    ...
    'scene_artisan_at_forge': Scene(
      ...
      dialogues: [
        DialogueLine(
          speaker: 'vn_brokkr'.tr(),
          text: 'vn_ending_artisan_p3_brokkr'.tr(),
          characterImage: 'assets/images/vn/brokkr_suspicious.webp',
        ),
        DialogueLine(
          speaker: 'vn_loki'.tr(),
    ...
    'scene_artisan_working': Scene(
      ...
      dialogues: [
        ...
        DialogueLine(
          ...
          characterImage: 'assets/images/vn/asgard_palace_morning.webp',
        ),
        DialogueLine(
          speaker: 'vn_speaker_narrateur'.tr(),
