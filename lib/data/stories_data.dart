    ...
    MythStory(
      ...
      correctOrder: [
        ...
        MythCard(
          ...
          description: 'Alors que Thor allait frapper, Hymir rompt la ligne et le serpent disparaît dans les flots.',
    ...
    MythStory(
      ...
      correctOrder: [
        MythCard(
          ...
          description: 'Après la mort de Baldr, Loki s’enfuit, traqué par la colère des Ases.',
        ...
        MythCard(
          ...
          description: 'Les Ases, guidés par Odin, jurent de capturer Loki.',
        ...
        MythCard(
          ...
          description: 'Transformé en saumon, Loki tente d’échapper aux dieux mais finit piégé.',
        ...
        MythCard(
          ...
          description: 'Les dieux décident d’un châtiment éternel pour Loki.',
        ...
        MythCard(
          ...
          description: 'Loki est cloué à la roche par les entrailles de ses enfants.',
        ...
        MythCard(
          ...
          description: 'Un serpent venimeux goutte sur Loki, mais Sigyn tente d’adoucir son supplice.',
