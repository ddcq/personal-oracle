...
class AppData {
  static const Map<String, Deity> deities = {
    ...
    'viking_1': Deity(
      id: 'viking_1',
      name: 'Viking 1',
      title: 'Le Guerrier Roux',
      icon: 'assets/images/heads/viking_head_1.png',
      traits: {'strength': 4, 'courage': 3, 'honor': 2},
      description: 'Un guerrier au cœur ardent, toujours prêt pour la bataille.',
      dailyChallenge: 'Affronte un petit défi avec détermination.',
      colors: [Color(0xFFD97706), Color(0xFFB45309)],
    ),
    'viking_2': Deity(
      id: 'viking_2',
      name: 'Viking 2',
      title: 'Le Sage Barbu',
      icon: 'assets/images/heads/viking_head_2.png',
      traits: {'wisdom': 4, 'cunning': 3, 'honor': 2},
      description: 'Un ancien sage dont la barbe cache de nombreux secrets.',
      dailyChallenge: 'Partage une sagesse avec quelqu\'un.',
      colors: [Color(0xFF334155), Color(0xFF0F172A)],
    ),
    'viking_3': Deity(
      id: 'viking_3',
      name: 'Viking 3',
      title: 'La Valkyrie Dorée',
      icon: 'assets/images/heads/viking_head_3.png',
      traits: {'courage': 4, 'passion': 3, 'strength': 2},
      description: 'Une guerrière lumineuse, porteuse de gloire et de courage.',
      dailyChallenge: 'Inspire quelqu\'un par ton exemple.',
      colors: [Color(0xFFDAA520), Color(0xFFB8860B)],
    ),
    'viking_4': Deity(
      id: 'viking_4',
      name: 'Viking 4',
      title: 'La Protectrice Fière',
      icon: 'assets/images/heads/viking_head_4.png',
      traits: {'honor': 4, 'justice': 3, 'strength': 2},
      description: 'Fidèle à ses principes, elle défend les siens avec ferveur.',
      dailyChallenge: 'Défends une cause juste aujourd\'hui.',
      colors: [Color(0xFF2563EB), Color(0xFF1E40AF)],
    ),
    'viking_5': Deity(
      id: 'viking_5',
      ...
      icon: 'assets/images/heads/viking_head_5.png',
      traits: {'nature': 4, 'passion': 3, 'wisdom': 2},
      description: 'Douce et mystérieuse, elle est connectée aux forces de la nature.',
      dailyChallenge: 'Passe du temps en pleine nature.',
      colors: [Color(0xFFDB2777), Color(0xFFBE185D)],
    ),
    'viking_6': Deity(
      id: 'viking_6',
      name: 'Viking 6',
      title: 'La Reine Ardente',
      icon: 'assets/images/heads/viking_head_6.png',
      traits: {'cunning': 4, 'passion': 3, 'strength': 2},
      description: 'Une reine au tempérament de feu, dont la ruse est redoutable.',
      dailyChallenge: 'Utilise ton ingéniosité pour résoudre un problème.',
      colors: [Color(0xFFDC2626), Color(0xFFB91C1C)],
    ),
  };
