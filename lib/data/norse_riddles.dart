...
final List<NorseRiddle> norseRiddles = [
  ...
  NorseRiddle(
    name: 'TYR',
    clues: [
      'norse_riddle_tyr_clue_1',
      'norse_riddle_tyr_clue_2',
      'norse_riddle_tyr_clue_3',
    ],
  ),
  // 4 Letters
  NorseRiddle(
  ...
  NorseRiddle(
    ...
    clues: [
      ...
      'norse_riddle_loki_clue_2',
      'norse_riddle_loki_clue_3',
    ],
  ),
  // 5 Letters
  NorseRiddle(
  ...
  NorseRiddle(
    name: 'ASGARD',
    clues: [
      'norse_riddle_asgard_clue_1',
      'norse_riddle_asgard_clue_2',
      'norse_riddle_asgard_clue_3',
    ],
  ),
  NorseRiddle(
    name: 'HUGINN',
  ...
  NorseRiddle(
    name: 'MIDGARD',
    clues: [
      'norse_riddle_midgard_clue_1',
      'norse_riddle_midgard_clue_2',
